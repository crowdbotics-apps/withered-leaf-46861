"""
Django settings for withered_leaf_46861 project.
...
ROOT_URLCONF = 'withered_leaf_46861.urls'
...
WSGI_APPLICATION = 'withered_leaf_46861.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_leaf_46861 API",
    "DESCRIPTION": "API documentation for withered_leaf_46861 App",
    "VERSION": "v1",
}
